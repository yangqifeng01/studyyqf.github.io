						...
						<div class="row">
							<div class="col-xs-12">
								<div class="widget-header widget-header-blue widget-header-flat">
									<h4 class="widget-title lighter">添加景点</h4>
								</div>
							<div>
								<form action="${pageContext.request.contextPath}/admin/addScenery" class="form-inline" method="post" enctype="multipart/form-data">
								<div class="row">
									<span class="col-md-6" style="margin: 5px 0">
										<label for="name">景点名称：</label><input id="name" type="text" name="name" style="width: 300px;"/>
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="openTime">开放时间：</label><input id="openTime" type="text" name="openTime" style="width: 400px;">
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="address">景点位置：</label><input id="address" type="text"  name="address" style="width: 400px;"/>
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="rates">门票价格：</label><input id="rates" type="text" name="rates">
									</span>
									<span class="col-md-12" style="margin: 5px 0">
										<label for=introduction>景点描述：</label><input id="introduction" type="text" name="introduction" style="width: 800px"/>
									</span>
									<span class="col-md-12" style="margin: 5px 0">
								...
								<textarea id="myEditor" style="padding-top: 2px;padding-bottom:5px;width: 1030px;height: 200px" name="content"></textarea>
									<%--超级管理员添加内容--%>
