...
<body>
    ...
    <div style="width: 1000px;margin-left: 125px;">
        <div align="center" style="margin: 10px"><label style="font-size: 300%;color: red;">${news.newsTitle}</label></div>
        <p align="center"><img src="<%=basePath%>/${news.newsImage}" alt="${news.newsTitle}" style="color: rgb(0, 0, 153); text-decoration-line: none;height: 200px;width: 400px"></p>
    ...
    <script>
        $(function (){
            ...
            $.ajax({
                ...
                data:{"aboutName":'${news.newsTitle}',"type":3},
                type: "post",
        ...
        function putComment(){
            ...
            if(commentContent === ''){
                ...
                let data = {"commentContent":commentContent,"userId":"${normalUser.userId}",
                    "aboutName":'${news.newsTitle}',"type":3};
                $.ajax({
                    dataType: "json",
