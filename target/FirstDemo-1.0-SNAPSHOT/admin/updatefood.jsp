						...
						<div class="row">
							...
							<div>
								...
								<div class="row">
									...
									<c:if test="${food.state == 1 && user.status == 2}">
										<span class="col-md-12" style="margin: 5px 0">
											<label>审核未通过原因：</label><input type="text" style="width: 800px" value="${food.checkMsg}"/>
										</span>
									</c:if>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="foodName">美食名称：</label><input id="foodName" type="text" name="foodName" style="width: 300px;" value="${food.foodName}"/>
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="foodAddress">美食位置：</label><input id="foodAddress" type="text" name="foodAddress" style="width: 400px;" value="${food.foodAddress}">
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="foodPrice">美食价格：</label><input id="foodPrice" type="text" name="foodPrice" style="width: 300px" value="${food.foodPrice}">
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<span><label>美食类型：</label></span>
										<label ><input type="radio" value="1" name="types" style="vertical-align: text-bottom;margin-bottom: 2px;" ${(1 eq food.types)?"checked":""}> 特色菜 </label>
										<label><input type="radio" value="2" name="types" style="vertical-align: text-bottom;margin-bottom: 2px;" ${(2 eq food.types)?"checked":""}> 风味小吃 </label>
									</span>
									<span class="col-md-12" style="margin: 5px 0">
								...
								<textarea id="myEditor" style="padding-top: 2px;padding-bottom:5px;width: 1030px;height: 200px" name="foodContent">${food.foodContent}</textarea>
									<%--任何管理员修改--%>
