			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="javascript:void(0)">修改用户信息</a>
						</li>
					</ul><!-- /.breadcrumb -->
							...
							<div class="col-xs-12">
								...
								<div class="widget-box">
									<div class="widget-header widget-header-blue widget-header-flat">
										<h4 class="widget-title lighter">修改用户信息</h4>
									</div>
										...
										<div class="widget-main">
											...
											<div class="step-content pos-rel" id="step-container">
												<div class="step-pane active" id="step1">
													<h3 class="lighter block blue">请修改用户信息</h3>
													...
													<form:form action="${pageContext.request.contextPath}/admin/updateUser" class="form-horizontal " id="validation-form" method="post" enctype="multipart/form-data">
														<div class="col-md-8">
															<input type="text" name="userId" id="userId" class="col-xs-12 col-sm-4 " value="${nowUser.userId}" hidden/>
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="userName">用户名:</label>
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="userName" id="userName" class="col-xs-12 col-sm-4 " value="${nowUser.userName}"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="text" name="password" id="password" class="col-xs-12 col-sm-4" value="${nowUser.password }"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
																		<input type="email" name="email" id="email" class="col-xs-12 col-sm-4" value="${nowUser.email }"/>
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label>
																			<input name="sex" value="1" type="radio" class="ace"  ${(1 eq nowUser.sex)?"checked":"" }/>
																	...
																	<div>
																		<label>
																			<input name="sex" value="2" type="radio" class="ace" ${(2 eq nowUser.sex)?"checked":"" }/>
															...
															<div class="form-group">
																...
																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label>
																			<input name="status" value="1" type="radio" class="ace"  ${(1 eq nowUser.status)?"checked":"" }/>
																	...
																	<div>
																		<label>
																			<input name="status" value="2" type="radio" class="ace" ${(2 eq nowUser.status)?"checked":"" }/>
															...
															<div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right">用户状态</label>

																<div class="col-xs-12 col-sm-9">
																	<div>
																		<label class="line-height-1 blue">
																			<input name="state" value="1" type="radio" class="ace" ${(1 eq nowUser.state)?"checked":"" }/>
																			<span class="lbl"> 可登录</span>
																		</label>
																	</div>

																	<div>
																		<label class="line-height-1 blue">
																			<input name="state" value="0" type="radio" class="ace" ${(0 eq nowUser.state)?"checked":"" }/>
														...
														<div class="form-group col-md-4">
															<div class="col-sm-12">
																<div class="clearfix">
																	<img id="headPro" src="<%=basePath%>/${nowUser.headPro}" height="180px" width="150px" alt="${nowUser.userName}" style="border: #00a0e9 1px solid">
																</div>
															</div>
															<div class="col-sm-12">
																<div class="clearfix">
