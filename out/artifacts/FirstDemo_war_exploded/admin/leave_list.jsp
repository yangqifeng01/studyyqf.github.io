			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="admin/comment_list.jsp">留言信息</a>
						</li>
					</ul><!-- /.breadcrumb -->
										...
										<table id="sample-table-1" class="table table-striped table-bordered table-hover">
											...
											<tbody>
												...
												<tr>
													...
													<c:if test="${leave.leaveSex ==1}">
														<td>男</td>
													</c:if>

													<c:if test="${leave.leaveSex ==2}">
														<td>女</td>
													</c:if>
													...
													<td>
														<div class="hidden-sm hidden-xs btn-group">
															<button class="btn btn-xs btn-danger" onclick="Delete('${leave.id}')">
				...
				bootbox.confirm({
					...
					callback: function (result) {
						if (result) {
							$.ajax({
								"async":true,
								"url":"${pageContext.request.contextPath}/admin/deleteLeave",
