			...
			<div class="main-content">
				...
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li>
							<a href="form-wizard.html">增加新闻</a>
						</li>
					</ul><!-- /.breadcrumb -->
				...
				<div class="page-content">
					...
					<div class="page-content-area">
						<div class="row">
							<div class="col-xs-12">
							<div>
								<form action="${pageContext.request.contextPath}/admin/addNews" class="form-inline" method="post" enctype="multipart/form-data">
								<div class="row">
									<span class="col-md-6" style="margin: 5px 0">
										<label for="newsTitle">新闻标题：</label><input id="newsTitle" type="text" name="newsTitle" style="width: 400px;"/>
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<label for="newsAuthor">新闻作者：</label><input id="newsAuthor" type="text" name="newsAuthor" style="width: 200px;">
									</span>
									<span class="col-md-6" style="margin: 5px 0">
										<span><label style="text-align: center">新闻类型：</label></span>
										<label style="margin: 5px 0"><input type="radio" value="1" name="newsTypes" style="vertical-align: text-bottom;margin-bottom: 2px;"> 旅游动态 </label>
										<label style="margin: 5px 0"><input type="radio" value="2" name="newsTypes" style="vertical-align: text-bottom;margin-bottom: 2px;"> 旅游公告 </label>
									</span>
									<span class="col-md-6" style="margin: 5px 0">
								...
								<textarea id="myEditor" style="padding-top: 2px;padding-bottom:5px;width: 1030px;height: 200px" name="newsContent"></textarea>
								<%--超级管理员添加内容--%>
