...
<body>
    ...
    <div style="width: 1000px;margin-left: 125px;">
        <div align="center" style="margin: 10px"><label style="font-size: 300%;color: red;">${scenery.name}</label></div>
        <p align="center"><img src="<%=basePath%>/${scenery.image}" alt="${scenery.name}" style="color: rgb(0, 0, 153); text-decoration-line: none;height: 300px;width: 500px"></p>
        <p style="margin-top: 10px; font-size: 150%; line-height: 25.2px; text-indent: 25px; font-family: 宋体; white-space: normal; background-color: rgb(255, 255, 255);color: #1d953f" align="center">${scenery.introduction}</p>
        <p style="margin: 2px; font-size: 14px; line-height: 25.2px; text-indent: 25px; font-family: 宋体; white-space: normal; background-color: rgb(255, 255, 255);">${scenery.content}</p>
        <p style="margin: 2px; font-size: 14px; line-height: 25.2px; text-indent: 25px; font-family: 宋体; white-space: normal; background-color: rgb(255, 255, 255);">地址：${scenery.address}</p>
        <p style="margin: 2px; font-size: 14px; line-height: 25.2px; text-indent: 25px; font-family: 宋体; white-space: normal; background-color: rgb(255, 255, 255);">开放时间：${scenery.openTime}</p>
        <p style="margin: 2px; font-size: 14px; line-height: 25.2px; text-indent: 25px; font-family: 宋体; white-space: normal; background-color: rgb(255, 255, 255);">
            门票：<c:choose>
                <c:when test="${scenery.rates} - 0.0 == 0">免费</c:when>
                <c:otherwise>${scenery.rates} 元</c:otherwise>
                </c:choose>
        </p>
    </div>
    ...
    <script>
        ...
        $.ajax({
            ...
            data:{"aboutName":'${scenery.name}',"type":1},
            type: "post",
